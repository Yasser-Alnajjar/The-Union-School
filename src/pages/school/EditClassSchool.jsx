...
export default function EditClassSchool() {
  ...
  useEffect(() => {
    setValue("lecture", editClassData.lecture);
    ...
    setValue("language", editClassData.language);
            ...
            <Row className="flex-wrap justify-content-center">
              <Col md="8" className="mb-3">
                <InputFC
                  ...
                  lableStyle={errors?.lecture ? "text-danger" : "text-black-50"}
                />
                <ErrorMessage errors={errors.lecture} />
              </Col>
              <Col md="8" className="mb-3">
                <InputFC
                  errors={errors}
